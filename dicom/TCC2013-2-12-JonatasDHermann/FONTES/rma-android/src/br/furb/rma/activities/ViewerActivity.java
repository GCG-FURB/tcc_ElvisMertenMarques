...
public class ViewerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		volumetricContainer = new VolumetricContainer(this, dicom, null);
		volumetricView.addView(volumetricContainer);
		
		sagitalView = (LinearLayout) findViewById(R.viewer.sagital_container);
		sagitalContainer = new SagitalContainer(this, dicom, new ContainerListener() {
		...
		axialContainer = new AxialContainer(this, dicom, new ContainerListener() {
		...
		coronalContainer = new CoronalContainer(this, dicom, new ContainerListener() {
